...
| 平均 1-way TVD（複数シード）↓ | **0.088 ± 0.020** | **0.088 ± 0.027** | 0.102 ± 0.004 |
| 下流タスク TSTR AUC（複数シード）↑ | **0.687 ± 0.068** | 0.677 ± 0.117 | 0.506 ± 0.079 |
...
- 単一シードでは AIM > MST（AUC 0.758 vs 0.663）に見えたが、複数シードでは差 0.010 と
  **標準偏差の中に消えた**（実験B: MST 0.687±0.068 ≈ AIM 0.677±0.117)。機構間の小さな差で意思決定する場合は、
